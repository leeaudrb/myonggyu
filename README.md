...
이제 이 html파일들을 전부 적용하면 이렇게 나타납니다.  

![4-32](./images/4-32.png)  
![4-33](./images/4-33.png)  

아직 요소가 배치되지 않아서 세로로 길쭉한 모습입니다.  
이것을 정리하기 위해서는 CSS파일을 작성해야 합니다.  
외부 스타일 시트를 적용하기 위해서는 html파일의 head부분 사이에  
link type="text/css" rel="stylesheet" href="파일명.css"를 작성해야 합니다.  

![4-34](./images/4-34.png)  

mystyle.css파일을 다음과 같이 작성했습니다.  

![4-35](./images/4-35.png)  
![4-36](./images/4-36.png)  
![4-37](./images/4-37.png)  
![4-38](./images/4-38.png)  

작성 다하고 이 파일을 html파일들과 같은 경로에 두고 실행해보면 다음과 같이 나타납니다.  

![4-39](./images/4-39.png)  

nav부분의 글자에 마우스 커서를 갖다대면 밑줄이 생기고

![4-40](./images/4-40.png)  

aside id="left"의 리스트에 마우스 커서를 갖다대면 검은색이 빨간색으로 변합니다.  

이것들을 작성하면서 공부해보니까 html과 css문법에 대해서는 완벽하게는 아니지만 어느 정도 이해했습니다.  
이벤트 처리를 위해서 자바스크립트를 공부할려고 했었는데  
책을 자세히 보니까 상대적으로 쉬운 jQuery가 있습니다.  
똑같은 동작을 하는 코드를 비교해 보면  

자바스크립트 : document.getElementsById("myPara").innerHTML = "안녕하세요?"  
jQuery : $("#myPara").html("안녕하세요?");  

딱 봐도 내용이 더 짧은 jQuery가 더 효율적인데 몇몇의 장점을 더 설명하자면  
1. HTML 문서에서 특정 요소를 쉽게 찾을 수 있습니다.  
2. 이벤트를 쉽게 처리할 수 있습니다.  
